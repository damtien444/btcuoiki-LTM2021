...
class Demo():
    ...
    def save_video(self, link_save="", id=""):
        ...
        # out = cv2.VideoWriter(path, cv2.VideoWriter_fourcc(*'MP4V'), 20, (frame_width, frame_height))
...
# path = "../Violence_video/src/weights/convlstm3d_128_16.pth"
def main():
    cfg =  get_cfg()
    stream = Demo(cfg)
    stream.load_model("../Violence_video/src/weights/convlstm3d_128_16.pth")
    stream.read_video("src/datasets/violence.mp4")
